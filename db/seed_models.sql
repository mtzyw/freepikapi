...
-- Video generation (examples; extend with WAN/Seedance variants)
INSERT INTO models (name, kind, operation, request_style, request_endpoint, status_endpoint_template, is_async, supports_webhook, params_schema)
VALUES
...
-- Additional Image Generation models (from docs)
INSERT INTO models (name, kind, operation, request_style, request_endpoint, status_endpoint_template, is_async, supports_webhook, params_schema)
VALUES
  ...
  -- Alias names to match your requested list
...
-- Additional Video Generation models (Kling families)
INSERT INTO models (name, kind, operation, request_style, request_endpoint, status_endpoint_template, is_async, supports_webhook, params_schema)
VALUES
  ...
  ('image-to-video-kling-pro','video','image_to_video','json','/v1/ai/image-to-video/kling-pro','/v1/ai/image-to-video/kling/{task-id}', true, true,
    '{"type":"object","properties":{"prompt":{"type":"string"}}}'::jsonb
  ),
  ('image-to-video-kling-std','video','image_to_video','json','/v1/ai/image-to-video/kling-std','/v1/ai/image-to-video/kling/{task-id}', true, true,
    '{"type":"object","properties":{"prompt":{"type":"string"}}}'::jsonb
  ),
...
-- Additional Video Generation models (Minimax/Seedance variants)
INSERT INTO models (name, kind, operation, request_style, request_endpoint, status_endpoint_template, is_async, supports_webhook, params_schema)
VALUES
